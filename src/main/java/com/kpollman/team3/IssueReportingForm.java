...
public class IssueReportingForm extends JPanel {
    ...
    public IssueReportingForm(String defaultCategory) {
        ...
        boothIdField = new ModernUI.ModernTextField(String.valueOf(Session.userId));
        gbc.gridx = 1;
        ...
        submitButton = new ModernUI.ModernButton("Submit Report");
    ...
    private void submitIssue() {
        ...
        String category = ((String) categoryDropdown.getSelectedItem()).replace(" ", "");
        ...
        try (Connection conn = DatabaseHelper.getConnection()) {
            ...
            pstmt.setInt(3, Integer.parseInt(boothIdStr));
            pstmt.setString(4, urgency);
            pstmt.setString(5, String.valueOf(Session.userId));
            pstmt.executeUpdate();
