...
import com.kpollman.model.PollingIssue;
...
public class IssueDetailsScreen extends JPanel {
    ...
    public IssueDetailsScreen(int issueId) {
        ...
        if (!"VOTER".equals(Session.role)) {
            ...
            assignPriorityButton.addActionListener(e -> MainDashboard.showView(new PriorityAssignmentScreen(issueId)));
            resolutionButton.addActionListener(e -> MainDashboard.showView(new ResolutionManagementScreen(issueId)));
        }
